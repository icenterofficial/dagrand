...
import { useArticles } from '../context/ArticleContext'; // Changed Import
  ...
  return (
    <div className="bg-white dark:bg-slate-900 min-h-screen transition-colors duration-300 pb-20">
       ...
       <div className="h-1 bg-slate-100 fixed top-0 left-0 w-full z-50">
          ...
          {/* Note: Real scroll progress needs JS state, keeping it simple for now */}
       </div>
            ...
            <div className="absolute inset-0 flex items-center">
                <div className="max-w-4xl mx-auto px-6 w-full">
                    ...
                    <div className="flex flex-wrap items-center gap-4 text-white/80 text-sm font-medium mb-4">
                        <span className="bg-gold-600 text-white px-3 py-1 rounded text-xs font-bold uppercase tracking-wider">
                            {categoryLabel}
                        </span>
       ...
       <div className="max-w-4xl mx-auto px-6 -mt-16 relative z-10">
            <div className="bg-white dark:bg-slate-900 rounded-xl shadow-2xl p-8 md:p-16 border-t-4 border-gold-500 relative overflow-hidden">
                ...
                <div className="flex items-center justify-between border-b border-slate-100 dark:border-slate-800 pb-8 mb-10">
                    ...
                    <button className="text-slate-400 hover:text-gold-600 transition-colors p-2 rounded-full hover:bg-slate-50 dark:hover:bg-slate-800">
                        <Share2 size={20} />
                    </button>
                </div>
                ...
                <div className="mt-16 pt-8 border-t border-slate-100 dark:border-slate-800">
                    <div className="flex items-center gap-2">
                        ...
                        <div className="flex gap-2">
                            <span className="bg-slate-100 dark:bg-slate-800 text-slate-600 dark:text-slate-300 px-3 py-1 rounded text-sm hover:bg-brand-900 hover:text-white transition-colors cursor-pointer">
                                {categoryLabel}
                            </span>
                            <span className="bg-slate-100 dark:bg-slate-800 text-slate-600 dark:text-slate-300 px-3 py-1 rounded text-sm hover:bg-brand-900 hover:text-white transition-colors cursor-pointer">
                                Law
